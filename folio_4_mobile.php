...
<head>
    ...
    <link href="./asset_mobile/css/style.css" rel="stylesheet" type="text/css">
    <link href="./asset_mobile/css/page_1.css" rel="stylesheet" type="text/css">
    <link href="./asset_mobile/css/page_2.css" rel="stylesheet" type="text/css">
    <link href="./asset_mobile/css/page_3.css" rel="stylesheet" type="text/css">
    <link href="./asset_mobile/css/page_4.css" rel="stylesheet" type="text/css">
    <link href="./asset_mobile/css/page_5.css" rel="stylesheet" type="text/css">
...
<body>
    <main id="main">
        ...
        <div class="contenu" id="page_1" >
            ...
            <div id="marge_bottom_page_4"></div>
        </div>
        <div class="contenu" id="page_2" >
            <div id="grand_cv">
                <div class="grand_cv_block_large" id="grand_cv_haut">
                    <div id="grand_cv_haut_gauche"><p>Morgan COULM  <br>25 ans (1995) <br>Permis B <br> morganXXXXXX@gmail.com <br> 133 rue Paul Masson <br> 29200 Brest <br>06 14 XX XX XX</p></div>
                ...
                <div class="grand_cv_block_large" >
                    ...
                    <div class="grand_cv_text"><span class="grand_cv_gauche">Technicien Réseau, SNCF services télécommunications, Brest</span><span class="grand_cv_date">2013-2014</span></div>
                    <div class="grand_cv_text"><span class="grand_cv_gauche">Agent de maintenance domotique et informatique, VINCI, Brest</span><span class="grand_cv_date">2012-2013</span></div>
                ...
                <div class="grand_cv_block_large" >
                    ...
                    <div class="grand_cv_text"><span class="grand_cv_gauche">Baccalauréat professionnel Systèmes électroniques et numériques (SEN)</span><span class="grand_cv_date">2014</span></div>
                </div>
                <div class="grand_cv_block_large" >
                    <p>Centres d'intérêts</p>
                    <div class="grand_cv_text"><span class="grand_cv_gauche">truc cool</span></div>
        ...
        <div class="contenu" id="page_3" >
            <div>
                <div class="moitier_page_3" id="list" onclick="page_3('list')">
                    <div id="text_list">
                        <p>
                ...
                <div class="moitier_page_3" id="index" onclick="page_3('index')">
                    <div id="text_index">
                        <p>
        ...
        <div class="contenu" id="page_4" >
            <div>
                <div class="ligne_page_4" id="html">
                    <div><div class="titre_page_4">html</div><div class="trais"></div></div>
                    <div class="contenu">
                ...
                <div class="ligne_page_4" id="bootstrap">
                    <div><div class="titre_page_4">Bootstrap</div><div class="trais"></div></div>
                    <div class="contenu">
                ...
                <div class="ligne_page_4" id="algo">
                    <div><div class="titre_page_4">Algorithmie</div><div class="trais"></div></div>
                    <div class="contenu">
                ...
                <div class="ligne_page_4" id="js">
                    <div><div class="titre_page_4">Javascript</div><div class="trais"></div></div>
                    <div class="contenu">
                ...
                <div class="ligne_page_4" id="php">
                    <div><div class="titre_page_4">Php</div><div class="trais"></div></div>
                    <div class="contenu">
        ...
        <div class="contenu" id="page_5">
            <div class="formulaire">
                ...
                <div class="form_large" id="form_action">
                    ...
                    <div class="form_moitie">
                        <input type="submit" value="Envoyer le Message" class="primary" id="envoie">
                    </div>
                </div>    
                </form>
    ...
    <nav>
        <div onclick="page(1)"><img src="./asset/image/design_icon_home.png"></div>
        <div onclick="page(2)"><img src="./asset/image/design_icon_cv.png"></div>
        <div onclick="page(3)"><img src="./asset/image/design_icon_liste.png"></div>
        <div onclick="page(4)"><img src="./asset/image/design_icon_exo.png"></div>
        <div onclick="page(5)"><img src="./asset/image/design_icon_mail.svg"></div>
    </nav>
    <div id="sous_page">bonjour</div>
    <script src="./asset_mobile/js_mobile/js_mobile.js"></script>
</body>
</html>